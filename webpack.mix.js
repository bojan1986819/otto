...
mix.js('resources/assets/js/app.js', 'public/js')
   .sass('resources/assets/sass/app.scss', 'public/css')
    ...
    .scripts('resources/assets/js/all.js', 'public/js/all.js').version()
    // .styles([
    //     'resources/assets/css/phpgrid/jquery-ui.custom.css',
    //     'resources/assets/css/phpgrid/ui.jqgrid.css'
    // ],'public/css/vendor.css')
;
mix.styles(['resources/assets/css/slim.css','resources/assets/css/lightbox.min.css'], 'public/css/vendor.css').version();
